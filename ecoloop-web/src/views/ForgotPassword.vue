...
const handleResetRequest = async () => {
  ...
  try {
    ...
    isError.value = true
    message.value = 'Could not reach the server. Please check your connection.'
  } finally {
  ...
  <div class="login-page">
    ...
    <div class="login-card">
      ...
      <form class="login-form" @submit.prevent="handleResetRequest">
        ...
        <p v-if="message" :style="{ color: isError ? '#D64545' : '#778732', fontSize: '13px', margin: '0' }">
          {{ message }}
        </p>

        <div class="actions">
          <button type="submit" class="btn-login" :disabled="isSubmitting || (!isError && message !== '')">
...
/* (I am assuming you are using a shared CSS file for these layout classes, but if they are scoped in Login.vue, you should copy them directly into this block) */
/* Page Layout */
.login-page {
  width: 100%;
  min-height: 100vh;
