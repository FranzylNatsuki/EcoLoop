          ...
          <div v-if="currentStep === 1" class="form-columns">
            ...
            <div class="right-column">
              <div class="form-group">
                ...
                <input id="event-date" v-model="formData.date" type="date" class="input-box" required />
              </div>

              <div class="time-fields-row">
                <div class="form-group flex-1">
                  <label for="start-time" class="field-label">Start Time</label>
                  <input id="start-time" v-model="formData.startTime" type="time" class="input-box" required />
                </div>
                <div class="form-group flex-1">
                  <label for="end-time" class="field-label">End Time</label>
                  <input id="end-time" v-model="formData.endTime" type="time" class="input-box" required />
                </div>
              </div>
